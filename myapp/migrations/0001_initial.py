...
>>>>>>> 806359e7d6cfe6fea1a3372add4fdf83c1716aa4
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Quiz',
            fields=[
                ('quiz_name', models.CharField(max_length=50, primary_key=True, serialize=False)),
            ],
        ),
        migrations.CreateModel(
            name='Student',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tot_grade', models.DecimalField(decimal_places=0, max_digits=3, null=True)),
